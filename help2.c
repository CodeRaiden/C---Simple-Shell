...
/**
 * helpAlias - the instructions on how to exit
 * @build: input build
 * Return: Always 1
 */
...
/**
 * helpCd - the instructions on how to exit
 * @build: input build
 * Return: Always 1
 */
...
/**
 * helpSetenv - the instructions on how to exit
 * @build: input build
 * Return: Always 1
 */
...
/**
 * helpUnsetenv - the instructions on how to exit
 * @build: input build
 * Return: Always 1
 */
...
/**
 * helpHelp - the instructions on how to exit
 * @build: input build
 * Return: Always 1
 */
